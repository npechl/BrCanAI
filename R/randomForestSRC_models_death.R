...
r1$importance |> writexl::write_xlsx("output/Death predictors/exp1-variableImportance.xlsx")

svg(filename = "output/Death predictors/exp1.svg", width = 20, height = 10)
r1$obj |> plot(cex = .5)
dev.off()
...
r2$importance |> writexl::write_xlsx("output/Death predictors/exp2-variableImportance.xlsx")

svg(filename = "output/Death predictors/exp2.svg", width = 20, height = 10)
r2$obj |> plot()
dev.off()
...
r4$importance |> writexl::write_xlsx("output/Death predictors/exp3-variableImportance.xlsx")

svg(filename = "output/Death predictors/exp3.svg", width = 20, height = 10)
r4$obj |> plot()
dev.off()
...
r5$importance |> writexl::write_xlsx("output/Death predictors/exp4-variableImportance.xlsx")

svg(filename = "output/Death predictors/exp4.svg", width = 20, height = 10)
r5$obj |> plot()
dev.off()
